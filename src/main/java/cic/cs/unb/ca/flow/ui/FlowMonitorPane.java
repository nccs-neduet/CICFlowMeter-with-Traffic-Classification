...
public class FlowMonitorPane extends JPanel {
    ...
    //private Timer timer = new Timer(); //I have added
	...
	//initialize(); // my addition

        btnStop = new JToggleButton("Stop");
        btnStop.setMinimumSize(d);
        btnStop.setMaximumSize(d);
        btnStop.setEnabled(false);
	//timer.scheduleAtFixedRate(actionEvent -> stopTrafficFlow(), 1*60*1000, 1*60*1000);  //I have added
